        ...
        <div className="prose max-w-none">
          <section className="mb-8">
            <p className="text-gray-700 leading-relaxed mb-4">
              不動産管理株式会社（以下「当社」）は、お客様の個人情報保護の重要性について認識し、
          ...
          <section className="mb-8">
            <h2 className="mb-4">1. 個人情報の定義</h2>
            <p className="text-gray-700 leading-relaxed">
              本ポリシーにおいて、個人情報とは、個人情報保護法第2条第1項により定義された個人情報、
              すなわち、生存する個人に関する情報であって、当該情報に含まれる氏名、生年月日その他の記述等により
              特定の個人を識別することができるもの、及び他の情報と容易に照合することができ、
              それにより特定の個人を識別することができることとなるものをいいます。
            </p>
          </section>

          <section className="mb-8">
            <h2 className="mb-4">2. 個人情報の収集</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              当社は、以下の目的のために個人情報を収集することがあります。
            </p>
            <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
              <li>賃貸管理サービスの提供のため</li>
              <li>お問い合わせへの対応のため</li>
              <li>契約の履行及び管理のため</li>
              <li>サービスの改善及び新サービスの開発のため</li>
              <li>各種お知らせの送付のため</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
              ...
              <li>入居審査及び契約手続き</li>
              <li>賃料等の請求及び収納管理</li>
              <li>物件の維持管理及びメンテナンス</li>
              <li>お客様へのご連絡及び各種ご案内</li>
              <li>お問い合わせへの対応</li>
              <li>サービス向上のための分析</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            <h2 className="mb-4">4. 個人情報の第三者提供</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="mb-4">5. 個人情報の安全管理</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="mb-4">6. 個人情報の開示・訂正等</h2>
            <p className="text-gray-700 leading-relaxed">
              お客様は、当社に対してご自身の個人情報の開示等（利用目的の通知、開示、内容の訂正・追加・削除、利用の停止または消去、第三者への提供の停止）に関して、
              当社問合せ窓口に申し出ることができます。その際、当社はご本人確認をさせていただいた上で、合理的な期間内に対応いたします。
            </p>
          </section>

          <section className="mb-8">
            <h2 className="mb-4">7. お問い合わせ窓口</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              個人情報の取扱いに関するお問い合わせは、下記の窓口までお願いいたします。
            </p>
            <div className="bg-gray-50 p-6 rounded-lg">
              <p className="text-gray-700">
                不動産管理株式会社 個人情報お問い合わせ窓口<br />
          ...
          <section>
            <h2 className="mb-4">8. プライバシーポリシーの変更</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              当社は、法令の変更等に伴い、本ポリシーを変更することがあります。
              変更後のプライバシーポリシーについては、当社が別途定める場合を除いて、
